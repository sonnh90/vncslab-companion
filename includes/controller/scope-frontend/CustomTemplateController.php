...
class CustomTemplateController extends AbstractTemplateController{
    ...
    public function set_Template_Variables():void{
        ...
        $this->templateList[ self::$CUSTOM_TEMPLATE_ABSOLUTE_PATH ] = __( 'VNCSLAB Custom Template' , 'text-domain' );
    ...
    */
    ...
    public function add_Template_To_Default_CPT_Editor( $templates ){        
        ...
        $templates[ self::$CUSTOM_TEMPLATE_ABSOLUTE_PATH ] = __( 'VNCSLAB Custom Template' , 'text-domain' );

        return $templates;
    }//add_Template_To_Default_CPT_Editor 

    /** 1.2. Register the VNCSLAB Custom Template to the current active theme */
    public function register_Template_At_Cache_For_Default_CPT( $attributes ){
        $cacheKey = 'page-templates-'.md5( 'vncslab-custom-template'.get_theme_root().'/'.get_stylesheet() );
